...
with tabs[4]:
    ...
    st.markdown("---") 
    st.caption("🇺🇸 nglish text: Teacher-designed coding applications create tailored learning experiences, making complex concepts easier to understand through interactive and adaptive tools. They enhance engagement, provide immediate feedback, and support active learning.")
...
with tabs[6]:
   ...
   # Place Stroke Width, Stroke Color, and Background Color in the same row
    ...
    # Clear Canvas button
    if st.button("🗑️ Open / Clear Canvas"):
